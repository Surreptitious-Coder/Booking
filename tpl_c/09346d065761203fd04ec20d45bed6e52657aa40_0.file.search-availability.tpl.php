...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  ...
  'unifunc' => 'content_6115be4b6064f0_05098089',
...
function content_6115be4b6064f0_05098089 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                <?php if (count((($tmp = @$_smarty_tpl->tpl_vars['ResourceAttributes']->value)===null||$tmp==='' ? array() : $tmp))%2 != 0) {?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                <?php if (count((($tmp = @$_smarty_tpl->tpl_vars['ResourceTypeAttributes']->value)===null||$tmp==='' ? array() : $tmp))%2 != 0) {?>
                    <div class="col-sm-6 hidden-xs">&nbsp;</div>
                <?php }?>
            </div>
        </div>
