...
$conf['settings']['default.language'] = 'en_gb';                // find your language in the lang directory
$conf['settings']['script.url'] = $_SERVER['SERVER_NAME'] . str_replace('/index.php', '', $_SERVER['PHP_SELF']) . '/Web';   	                    // public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['database']['hostspec'] = '192.168.160.2';        // ip, dns or named pipe
 ...
 */
$conf['settings']['install.password'] = 'Hi';
/**
 * Pages
 */
